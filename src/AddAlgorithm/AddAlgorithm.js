...
const AddAlgorithm = () => {
    ...
    const loadCurrentAlgo = () => {
        ...
        const cur = context.currentAlgorithm
    ...
    const patchAlgo = () => {
        ...
        .map((step, i) => { return { id: i + "", item: step } })
        const newAlgo = {
            id: context.currentAlgorithm.id,
            algo_name: algoName,
            algo_description: algoDescription,
            algo_example: algoExample,
            time_complexity: algoTimeComplexity,
    ...
    return (
        <div className="modal">
            ...
            <p className="patch-current-algorithm" onClick={loadCurrentAlgo}>Patch Current</p>
            ...
            <button className={"add-algo-button " + (addButtonEnabled ? " enabled " : " disabled ")} onClick={addAlgo}>Add</button>
            <button className={"add-algo-button " + (addButtonEnabled ? " disabled " : " enabled ")} onClick={patchAlgo}>Patch</button>
